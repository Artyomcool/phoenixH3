...
public class HMap {
    ...
    public static class MapHeader {
        ...
        public String name;         // variable-length, prefixed with 4-byte length
        public String description;  // variable-length, prefixed with 4-byte length
        ...
        public static class AvailableHeroes {
            ...
            public String heroName;      // readString32; may be empty if len=0 => standard name
            public int unknownGarbage;   // u8: observed 0x00 or arbitrary; no gameplay effect
            public ArrayList<NamedHero> playerHeroes; // custom heroes list

            public static class NamedHero {
                public int id;           // u8: hero identifier
                public String name;      // readString32
            ...
            public static AvailableHeroes read(HeroStream in) {
                ...
                int count = in.u32();
                ah.playerHeroes = new ArrayList<>(count);
        ...
        public abstract static class SpecialVictoryCondition {
            ...
            public static SpecialVictoryCondition read(HeroStream in) {
                int t = in.u8();
                return switch (t) {
                    case 0xFF -> None.read(in);
                    case 0x00 -> AcquireArtifact.read(in);
                    case 0x01 -> AccumulateCreatures.read(in);
                    case 0x02 -> AccumulateResources.read(in);
                    case 0x03 -> UpgradeTown.read(in);
                    case 0x04 -> BuildGrail.read(in);
                    case 0x05 -> DefeatHero.read(in);
                    case 0x06 -> CaptureTown.read(in);
                    case 0x07 -> DefeatMonster.read(in);
                    case 0x08 -> FlagAllCreatureDwellings.read(in);
                    case 0x09 -> FlagAllMines.read(in);
                    case 0x0A -> TransportArtifact.read(in);
                    default ->
            ...
            public static final class AcquireArtifact extends SpecialVictoryCondition {
                public int allowStandardEnding; // u8 (по спецификации "не работает", но читаем)
        ...
        public abstract static class SpecialLossCondition {
            ...
            public static SpecialLossCondition read(HeroStream in) {
                ...
                return switch (t) {
                    case 0xFF -> None.read(in);
                    case 0x00 -> LoseSpecificTown.read(in);
                    case 0x01 -> LoseSpecificHero.read(in);
                    case 0x02 -> TimeExpires.read(in);
                    default ->
        ...
        public static class Teams {
            ...
            // Order: Red, Blue, Tan, Green, Orange, Purple, Teal, Pink
        ...
        public static class FreeHeroes {
            ...
            public static FreeHeroes read(HeroStream in) {
                ...
                int count = in.u8();
                fh.configured = new ArrayList<>(count);
                for (int i = 0; i < count; i++) {
    ...
    public static class Rumors {
        ...
        public final ArrayList<Rumor> rumors = new ArrayList<>();
        ...
        public static class Rumor {
            public String rumor_name;
            public String rumor_text;
    ...
    public static class HeroStream {
        ...
        public String readString32() {
            int c = u32();
            String r = new String(in, p, c);
            p += c;
            return r;
        }

        public byte[] bytes(int i) {
            byte[] r = Arrays.copyOfRange(in, p, p + i);
            p += i;
            return r;
        }
    }
